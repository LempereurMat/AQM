...
include "function.php";
	...
	if ($option < 4)
	{	
		//echo "/usr/bin/python2.7 ".$local_path."serializetoc3d.py" . " " .escapeshellcmd(array_sum($LCycleNumber)). " " .escapeshellcmd(array_sum($RCycleNumber)). " 2>&1";		
		exec("/usr/bin/python2.7 ".$local_path."serializetoc3d.py" . " " .escapeshellcmd(array_sum($LCycleNumber)). " " .escapeshellcmd(array_sum($RCycleNumber)). " 2>&1");
	}
	elseif ($option==4)
	{
		exec("/usr/bin/python2.7 ".$local_path."serializetoc3d.py " . " " .escapeshellcmd($CycleNumber). " " .escapeshellcmd($CycleNumber). " 2>&1");
	}
